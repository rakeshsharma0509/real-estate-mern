...
function NewPostPage() {
  const [value, setValue] = useState(""); // text editor ke liye hook hai ye
  const [images, setImages] = useState([]);// ye images ka array liya hai 
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate("/"+res.data.id) // redirect to single page of the nwly created post app.jsx mein ye route handle ho rha hai
    } catch (err) {
      console.log(err);
      setError(error);
    }
